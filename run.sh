...
Help() {
  ...
  echo -e "* extract"
  echo -e "  Create the project tables necessary for the migration to Xray, you can use these flags: --only-attachments, --skip-attachments, --only-custom-fields, --skip-custom-fields, --only-additional-info, --skip-additional-info, --only-comments, --skip-comments, --only-plans-cycles-runs, --skip-plans-cycles-runs\n"
  echo -e "* migrate"
  echo -e "  Migrate the projects, you can use these flags: --only-attachments, --skip-attachments, --only-custom-fields, --skip-custom-fields, --only-comments, --skip-comments, --only-plans-cycles-runs, --skip-plans-cycles-runs\n"
  echo -e "* report"
